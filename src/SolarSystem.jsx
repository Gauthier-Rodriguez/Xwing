...
Command: npx gltfjsx@6.5.3 solar_system.glb 
...
export function SolarSystem(props) {
  ...
  const { nodes, materials, animations } = useGLTF('models/solar_system.glb')
        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group name="moon_BezierCircle_33"  scale={-1.879}>
                <group name="moon_31" position={[0, 0, -9.5]} rotation={[-0.023, 0, Math.PI / 2]} scale={0.025}>
